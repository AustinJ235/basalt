...
pub struct Context {
    ...
    image_capacity: u32,
    specific: Specific,
    // TODO: empty image, buffer, images, desc set
}
...
impl Context {
    ...
    pub fn set_extent(&mut self, _extent: [u32; 2]) {
    ...
    pub fn set_buffer_and_images(
        ...
        if images.len() as u32 > self.image_capacity {
            while self.image_capacity < images.len() as u32 {
            ...
            // TODO: Recreate descriptor set allocater
        }

        // TODO: Create descriptor set, set buffer & images
        todo!()
    }
